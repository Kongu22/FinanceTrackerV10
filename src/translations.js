const translations = {
  en: {
    ...
    enterStartWorkTime: 'Start Work Time', // New string for manual start time entry
    enterEndWorkTime: 'End Work Time', // New string for manual end time entry
    startTimeRecorded: 'Start time recorded successfully!', // New string for start time recorded notification
    endTimeRecorded: 'End time recorded successfully!', // New string for end time recorded notification
  },
  ru: {
    ...
    enterStartWorkTime: 'Введите время начала работы', // New string for manual start time entry
    enterEndWorkTime: 'Введите время окончания работы', // New string for manual end time entry
    startTimeRecorded: 'Время начала успешно зафиксировано!', // New string for start time recorded notification
    endTimeRecorded: 'Время окончания успешно зафиксировано!', // New string for end time recorded notification
  },
  he: {
    ...
    enterStartWorkTime: 'הזן את שעת התחלת העבודה', // New string for manual start time entry
    enterEndWorkTime: 'הזן את שעת סיום העבודה', // New string for manual end time entry
    startTimeRecorded: 'שעת התחלה נרשמה בהצלחה!', // New string for start time recorded notification
    endTimeRecorded: 'שעת סיום נרשמה בהצלחה!', // New string for end time recorded notification
  },
};
